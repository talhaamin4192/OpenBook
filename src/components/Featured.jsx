...
const Featured = () => {
    return (
        <div className=' h-screen w-full overflow-hidden sticky top-0 -z-50  border-t-1 grid grid-cols-2 font-display transition-all ease-in'>
            ...
            <div className='bg-white grid grid-cols-5 w-[145vw] [&>*]:border-l-1 text-xl [&>*]:flex [&>*]:pl-6 [&>*]:pb-7 [&>*]:justify-end [&>*]:gap-3 [&>*]:item-center [&>*]:flex-col'>
                <div>
